...
public class Add_HR_Manager extends javax.swing.JFrame {

    public Add_HR_Manager() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ADD HR MANAGER");
    ...
    try {
        HRManager manager = new HRManager(managerName, username, password);
        ManagerFileHandler.saveManagerDetails(manager);
        ...
        JOptionPane.showMessageDialog(this, "An error occurred while saving manager details.", "Error", JOptionPane.ERROR_MESSAGE);
        e.printStackTrace(); 
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Add_HR_Manager().setVisible(true);
            }
        });
    }
